      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            <h1 className="text-xl font-bold text-foreground">ELOQUENCE'25</h1>
            <nav className="hidden md:flex gap-6">
              <a href="#events" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                Events
              </a>
              <a href="#location" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                Location
              </a>
            </nav>
          </div>
  ...
  return (
    <div className="w-full py-12 sm:py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <p className="text-sm sm:text-base font-medium text-muted-foreground uppercase tracking-wide mb-2">
          C. Abdul Hakeem College of Engineering and Technology
        </p>
        <p className="text-xs sm:text-sm text-muted-foreground mb-1">
          Department of Computer Science and Engineering
        </p>
        <p className="text-xs sm:text-sm italic text-muted-foreground mb-6">
          proudly presents
        </p>

        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-foreground mb-3 tracking-tight">
          ELOQUENCE'25
        </h1>
